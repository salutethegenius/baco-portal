    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className={`relative z-10 text-center text-white px-4 max-w-6xl mx-auto transition-all duration-1000 ${
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight transition-all duration-1000 delay-700">
            BACO Conference 2025
          </h1>

          <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-gold-300 transition-all duration-1000 delay-900">
            Celebrating 25 Years of Compliance
          </h2>

          <p className="text-xl md:text-2xl mb-8 font-medium italic transition-all duration-1000 delay-1000">
            Rooted in Integrity, Growing with Purpose
          </p>

          {/* Event Quick Info */}
          <div className="flex flex-wrap justify-center gap-6 mb-10 text-lg transition-all duration-1000 delay-1100">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 transform hover:scale-105 transition-transform duration-200">
          ...
          <div className={`mb-12 transition-all duration-1000 delay-1100 ${
            ...
            <Button 
              ...
              size="lg"
              className="bg-gold-500 hover:bg-gold-600 text-black font-bold px-12 py-4 text-xl rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 animate-bounce hover:animate-none"
            >
              Register Now
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <Card 
                key={index} 
                className={`text-center p-6 hover:shadow-lg transition-all duration-1000 hover:transform hover:scale-105 ${
                  isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ transitionDelay: `${item.delay}ms` }}
              >
                <div className="w-16 h-16 bg-baco-primary rounded-full flex items-center justify-center mx-auto mb-4 transition-transform duration-300 hover:rotate-12">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <Card className={`p-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1900ms' }}>
